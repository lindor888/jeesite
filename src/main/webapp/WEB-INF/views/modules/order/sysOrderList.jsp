	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>订单状态</th>
				<th>下单时间</th>
				<shiro:hasPermission name="order:sysOrder:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="sysOrder" varStatus="status">
			<tr>
				...
				<td>
					${fns:getDictLabel(sysOrder.producttype, 'proType', '')}
				</td>
				<td>
					${sysOrder.product}
				</td>
				...
				<shiro:hasPermission name="order:sysOrder:edit"><td>
    				<a href="${ctx}/order/sysOrder/form?id=${sysOrder.id}">修改</a>
